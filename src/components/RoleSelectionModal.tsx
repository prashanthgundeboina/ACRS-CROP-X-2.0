...
export const RoleSelectionModal: React.FC<RoleSelectionModalProps> = ({
  ...
  const rolesList: Array<{
    ...
    },
    {
      ...
      titleLocal: language === 'hi' ? 'डिलीवरी पार्टनर' : 'Delivery Partner',
      subtitle: 'Agri inputs, bio-fertilizer & seed dispatch fleet operations',
      description: 'Accept dispatch orders, route navigation & verified proof-of-delivery.',
      badge: 'Logistics Fleet',
      color: 'from-emerald-600 to-teal-700',
      accentBg: 'bg-emerald-50 dark:bg-emerald-950/30',
      borderColor: 'border-emerald-500/40 hover:border-emerald-500',
      features: [
        '🗺️ Live Farm GPS & Turn-by-Turn Route',
        '🔊 Regional Language Voice Announcements',
        '🔑 OTP & QR Code Delivery Verification',
        '💰 Instant Payout & Daily Revenue Ledger',
      ],
    },
    {
      role: 'admin',
