...
**Live Production URL**: [https://croperx-2.onrender.com/](https://croperx-2.onrender.com/)
...
4. Configure your environment secrets:
   ...
   - `DATA_DIR`: Mount point for persistent disk (e.g. `/var/data`)
5. Click **Apply** — Render builds frontend & backend bundles and starts `node dist/server.cjs` with health checks at `/api/health`.

For full step-by-step production guidelines and verification results, see:
- [DEPLOYMENT.md](./DEPLOYMENT.md) — Comprehensive Render deployment and environment variables guide
- [PRODUCTION_CHECKLIST.md](./PRODUCTION_CHECKLIST.md) — Phase 46.5 End-to-end production readiness checklist
- [FINAL_TEST_REPORT.md](./FINAL_TEST_REPORT.md) — Complete audit and test verification report
